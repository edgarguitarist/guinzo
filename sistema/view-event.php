...
<body>
    ...
    <div class="is-center wd-100 top-nav">
        ...
        <div class="has-text-centered">
            ...
            <button class="button is-dark is-outlined is-size-5-desktop is-size-4 b-bolder" onclick="genPDF2('<?= 'Contrato_' . $namepdf; ?>', 'pdf_container_contrato')"><em class="fas fa-file-alt "></em> CONTRATO</button>
        </div>
    </div>
</body>
