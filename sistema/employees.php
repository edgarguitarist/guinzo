...
<body>
    ...
    <div class="is-center wd-100 top-nav">
        <div>
            <a class="addButton button is-dark is-outlined is-size-6-desktop is-size-4" id="addEmployee" onmouseover="buscarModal(this)" data-toggle="modal" href="#addEmployeeModal"><em class="has-text-success fas fa-plus"></em>Añadir Empleado</a>
