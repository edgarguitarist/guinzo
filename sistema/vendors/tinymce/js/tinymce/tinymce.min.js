    ...
    r(p, [f], function (e) {
      function t(n) {
        ...
        function _(e, t, r) {
          ...
          o == i
            ? w(D[V], D[z], D[U], D[q]) > 0 && D.collapse(e)
            : D.collapse(e),
            (D.collapsed = x()),
        ...
        (n = n || {}),
          ...
          (o.parse = function (e) {
            ...
            for (
              ...
              if (
                (l < s.index && a.text(I(e.substr(l, s.index - l))), (c = s[6]))
              )
                (c = c.toLowerCase()),
      ...
      return function (r, i) {
        ...
        function a(t) {
          ...
          (n = t.screenX - E),
            ...
            N[2] < 0 &&
              w.clientWidth <= D &&
              b.setStyle(w, "left", T + (A - D)),
            N[3] < 0 &&
              w.clientHeight <= L &&
              b.setStyle(w, "top", R + (B - L)),
            M ||
        ...
        function r(r) {
          ...
          if (
            ...
            (P && T === t.getBody()) ||
              ...
              h()
                ? ((B =
                    /^(H[1-6]|PRE|FIGURE)$/.test(D) && "HGROUP" != L
                      ? m(P)
                      : m()),
        ...
        u = e.extend({
          ...
          init: function (e) {
            ...
            d._super(e),
              ...
              e.popover &&
                ((d._preBodyHtml =
                  '<div class="' + d.classPrefix + 'arrow"></div>'),
      ...
      return function (a) {
        ...
        function d() {
          ...
          a.on("keydown", function (e) {
            ...
            if (!c(e) && (n == I || n == O)) {
              if (
                ((r = a.selection.isCollapsed()), r && !F.isEmpty(a.getBody()))
              )
                return;
              if (j && !r) return;
        ...
        return (
          (N.prototype = {
            render: function () {
              ...
              if (
                ((t.editorManager.settings = n),
                t.getElement() && b.contentEditable)
              ) {
                n.inline
                  ? (t.inline = !0)
                ...
                o &&
                  ...
                  n.hidden_input &&
                    ...
                    k.insertAfter(
                      k.create("input", { type: "hidden", name: r }),
                      r
                    ),
            ...
            initContentBody: function () {
              ...
              n.inline || (t.getElement().style.visibility = t.orgVisibility),
                ...
                t.parser.addNodeFilter("p,h1,h2,h3,h4,h5,h6,div", function (e) {
                  for (
                    var n = e.length, i, o = t.schema.getNonEmptyElements();
                    n--;
            ...
            setContent: function (e, t) {
              ...
              return (
                ...
                t.initial ||
                  (n.selection.select(r, !0), n.selection.collapse(!0)),
                t.content
              );
            },
            getContent: function (e) {
          ...
          return (
            e.settings.multiline &&
              ...
              (t.startMinH =
                t.h =
                t.minH =
                  Math.min(t.maxH, e.getEl().offsetHeight))),
            t
          );
        },
        disabled: function (e) {
            ...
            (r = e.menu),
              r
                ...
                : ((r = n.menu),
                  ...
                  (r = e.menu =
                    t.create(r).parent(e).renderTo(e.getContainerElm())),
                  r.reflow(),
                  r.fire("show"),
