...
<div class="field">
    ...
    <div class="field-body forms_row">
        ...
        <div class="control wd-4c">
            <div class="is-flex">
                <input id="password_profile" name="password" class="input" type="password" minlength="8" maxlength="20" placeholder="Contraseña" value="<?= $_SESSION['password'] ?? '' ?>" required>
                <a id="togglePassword" type="button" onclick="togglePassword('password_profile')" title="Mostrar Contraseña" class="button is-black is-inverted m-auto ph-5"><em id="eye" class="fas fa-eye"></em><em id="eye2" class="fas fa-eye-slash" hidden></em></a>
            </div>
            <p>&nbsp;</p>
        </div>
    </div>
