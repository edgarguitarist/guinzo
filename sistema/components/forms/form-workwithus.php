    ...
    <div class="field">
        ...
        <div class="field-body forms_row">
            <div class="control wd-3c">
                <input id="cedula_wwu" name="cedula" minlength="10" maxlength="10" class="input solo-numeros" onkeyup="checkCedula('root',this, true)" type="text" placeholder="Su Cédula" required>
