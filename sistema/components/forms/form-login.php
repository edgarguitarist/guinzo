                ...
                <form id="form_signup" name="form_signup" method="POST"  class="forms_form" action="sistema/components/root/signup-checker.php" >
                    <fieldset class="forms_fieldset">
                        ...
                        <div class="forms_field">
                            ...
                            <input title="Fecha de Nacimiento" type="date" style="position: relative; float: right;" max="<?php echo $minimo; ?>" value="<?php echo $minimo; ?>" id="birthday" name="birthday" class="forms_field-input wd-45" required />
                        </div>
                    </fieldset>
